...
local function VIPTabContent(tab)
    ...
    local midY = topY + HalfHeight + SectionsPadding
     ...
     local SectionTwo = MachoMenuGroup(tab, "Item Spawner", leftX, topY, leftX + ColumnWidth, topY + HalfHeight)
    local SectionOne = MachoMenuGroup(tab, "Exploits Crasher", leftX, midY, leftX + ColumnWidth, midY + HalfHeight)
